    ...
    def build_dqn(self):
        ...
        def build_branch(name, i, weight, concat_q, summary=summary):
            with tf.variable_scope(name):
                ...
                branch_out, weight['br_%s_q_w' % i], weight['br_%s_q_b' % i] = self.linear(hidden_layer2, 5, name='branch_out_%s' % i)

                summary += [hidden_layer1,hidden_layer2, branch_out, '']
                return branch_out
            ...
            if self.preset_lambda:
                ...
                qvalue = self.frl_q.eval(
                    {self.agent_q_input[0]: q_all[0], self.agent_q_input[1]: q_all[1],
                     ...
                     self.agent_q_input[4]: q_all[4], self.agent_q_input[5]: q_all[5],
