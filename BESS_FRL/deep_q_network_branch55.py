    ...
    def build_dqn(self):
        ...
        def build_branch(name, i, weight, concat_q, summary=summary):
            with tf.variable_scope(name):
                ...
                # name_q_w = 'b_%s_q_w' % i
                # name_q_b = 'b_%s_q_b' % i
                hidden_layer1, weight['br_%s_h1_w' % i], weight['br_%s_h1_b' % i] = self.linear(concat_q, 128, tf.nn.relu, name='branch_hidden1_%s' % i)
                #hidden_layer2, weight['br_%s_h2_w' % i], weight['br_%s_h2_b' % i] = self.linear(hidden_layer1, 64, tf.nn.relu, name='branch_hidden2_%s' % i)
                #hidden_layer3, weight['br_%s_h3_w' % i], weight['br_%s_h3_b' % i] = self.linear(hidden_layer2, 64, tf.nn.relu, name='branch_hidden3_%s' % i)
                #hidden_layer4, weight['br_%s_h4_w' % i], weight['br_%s_h4_b' % i] = self.linear(hidden_layer3, 64, tf.nn.relu, name='branch_hidden4_%s' % i)
                branch_out, weight['br_%s_q_w' % i], weight['br_%s_q_b' % i] = self.linear(hidden_layer1, 5, name='branch_out_%s' % i)

                summary += [hidden_layer1, branch_out, '']
                return branch_out

        def build_stateq(name, weight, concat_q, summary=summary):
            with tf.variable_scope(name):
                #concat_q = tf.concat(agent_q, axis=1)
                hidden_layer1, weight['sq_h1_w'], weight['sq_h1_b'] = self.linear(concat_q, 128, tf.nn.relu, name='stateq_h1')
                hidden_layer2, weight['sq_h2_w'], weight['sq_h2_b'] = self.linear(hidden_layer1, 64, tf.nn.relu, name='stateq_h2')
                #hidden_layer3, weight['sq_h3_w'], weight['sq_h3_b'] = self.linear(hidden_layer2, 64, tf.nn.relu, name='stateq_h3')
                #hidden_layer4, weight['sq_h4_w'], weight['sq_h4_b'] = self.linear(hidden_layer3, 32, tf.nn.relu, name='stateq_h4')
                out, weight['sq_q_w'], weight['sq_q_b'] = self.linear(hidden_layer2, 1, name='stateq_out')

                summary += [hidden_layer1,hidden_layer2, out, '']
                return out
        # ipdb.set_trace()
        ...
        if self.args.train_mode == 'single_alpha':
            ...
            if self.preset_lambda:
                ...
                postq = self.frl_t_q.eval({self.agent_q_input[0]: post_q_agent[0], #.eval(agent_q_input); " "
                                           ...
                                           self.agent_q_input[5]: post_q_agent[5],
                                           self.agent_q_input[6]: post_q_agent[6],
                                           self.agent_q_input[7]: post_q_agent[7],
                                           self.agent_q_input[8]: post_q_agent[8],
                                           self.agent_q_input[9]: post_q_agent[9],
                                           self.agent_q_input[10]: post_q_agent[10],
                                           self.agent_q_input[11]: post_q_agent[11],
                                           self.agent_q_input[12]: post_q_agent[12],
                                           self.agent_q_input[13]: post_q_agent[13],
                                           self.agent_q_input[14]: post_q_agent[14],
                                           self.agent_q_input[15]: post_q_agent[15],
                                           self.agent_q_input[16]: post_q_agent[16],
                                           self.agent_q_input[17]: post_q_agent[17],
                                           self.agent_q_input[18]: post_q_agent[18],
                                           self.agent_q_input[19]: post_q_agent[19],
                                           self.agent_q_input[20]: post_q_agent[20],
                                           self.agent_q_input[21]: post_q_agent[21],
                                           self.agent_q_input[22]: post_q_agent[22],
                                           self.agent_q_input[23]: post_q_agent[23],
                                           self.agent_q_input[24]: post_q_agent[24],
                                           self.agent_q_input[25]: post_q_agent[25],
                                           self.agent_q_input[26]: post_q_agent[26],
                                           self.agent_q_input[27]: post_q_agent[27],
                                           self.agent_q_input[28]: post_q_agent[28],
                                           self.agent_q_input[29]: post_q_agent[29],
                                           self.agent_q_input[30]: post_q_agent[30],
                                           self.agent_q_input[31]: post_q_agent[31],
                                           self.agent_q_input[32]: post_q_agent[32],
                                           self.agent_q_input[33]: post_q_agent[33],
                                           self.agent_q_input[34]: post_q_agent[34],
                                           self.agent_q_input[35]: post_q_agent[35],
                                           self.agent_q_input[36]: post_q_agent[36],
                                           self.agent_q_input[37]: post_q_agent[37],
                                           self.agent_q_input[38]: post_q_agent[38],
                                           self.agent_q_input[39]: post_q_agent[39],
                                           self.agent_q_input[40]: post_q_agent[40],
                                           self.agent_q_input[41]: post_q_agent[41],
                                           self.agent_q_input[42]: post_q_agent[42],
                                           self.agent_q_input[43]: post_q_agent[43],
                                           self.agent_q_input[44]: post_q_agent[44],
                                           self.agent_q_input[45]: post_q_agent[45],
                                           self.agent_q_input[46]: post_q_agent[46],
                                           self.agent_q_input[47]: post_q_agent[47],
                                           self.agent_q_input[48]: post_q_agent[48],
                                           self.agent_q_input[49]: post_q_agent[49],
                                           self.agent_q_input[50]: post_q_agent[50],
                                           self.agent_q_input[51]: post_q_agent[51],
                                           self.agent_q_input[52]: post_q_agent[52],
                                           self.agent_q_input[53]: post_q_agent[53],
                                           self.agent_q_input[54]: post_q_agent[54]
                                           })
        ...
        if self.args.train_mode == 'single_alpha':
            ...
            _, dloss_dQ, loss = self.sess.run([self.train_mlp,  # update mlp weights
                                                                 ...
                                                                 {#self.concat_q_input: concat_preq_input,
                                                                  ...
                                                                  self.agent_q_input[5]: pre_q_agent[5],
                                                                  self.agent_q_input[6]: pre_q_agent[6],
                                                                  self.agent_q_input[7]: pre_q_agent[7],
                                                                  self.agent_q_input[8]: pre_q_agent[8],
                                                                  self.agent_q_input[9]: pre_q_agent[9],
                                                                  self.agent_q_input[10]: pre_q_agent[10],
                                                                  self.agent_q_input[11]: pre_q_agent[11],
                                                                  self.agent_q_input[12]: pre_q_agent[12],
                                                                  self.agent_q_input[13]: pre_q_agent[13],
                                                                  self.agent_q_input[14]: pre_q_agent[14],
                                                                  self.agent_q_input[15]: pre_q_agent[15],
                                                                  self.agent_q_input[16]: pre_q_agent[16],
                                                                  self.agent_q_input[17]: pre_q_agent[17],
                                                                  self.agent_q_input[18]: pre_q_agent[18],
                                                                  self.agent_q_input[19]: pre_q_agent[19],
                                                                  self.agent_q_input[20]: pre_q_agent[20],
                                                                  self.agent_q_input[21]: pre_q_agent[21],
                                                                  self.agent_q_input[22]: pre_q_agent[22],
                                                                  self.agent_q_input[23]: pre_q_agent[23],
                                                                  self.agent_q_input[24]: pre_q_agent[24],
                                                                  self.agent_q_input[25]: pre_q_agent[25],
                                                                  self.agent_q_input[26]: pre_q_agent[26],
                                                                  self.agent_q_input[27]: pre_q_agent[27],
                                                                  self.agent_q_input[28]: pre_q_agent[28],
                                                                  self.agent_q_input[29]: pre_q_agent[29],
                                                                  self.agent_q_input[30]: pre_q_agent[30],
                                                                  self.agent_q_input[31]: pre_q_agent[31],
                                                                  self.agent_q_input[32]: pre_q_agent[32],
                                                                  self.agent_q_input[33]: pre_q_agent[33],
                                                                  self.agent_q_input[34]: pre_q_agent[34],
                                                                  self.agent_q_input[35]: pre_q_agent[35],
                                                                  self.agent_q_input[36]: pre_q_agent[36],
                                                                  self.agent_q_input[37]: pre_q_agent[37],
                                                                  self.agent_q_input[38]: pre_q_agent[38],
                                                                  self.agent_q_input[39]: pre_q_agent[39],
                                                                  self.agent_q_input[40]: pre_q_agent[40],
                                                                  self.agent_q_input[41]: pre_q_agent[41],
                                                                  self.agent_q_input[42]: pre_q_agent[42],
                                                                  self.agent_q_input[43]: pre_q_agent[43],
                                                                  self.agent_q_input[44]: pre_q_agent[44],
                                                                  self.agent_q_input[45]: pre_q_agent[45],
                                                                  self.agent_q_input[46]: pre_q_agent[46],
                                                                  self.agent_q_input[47]: pre_q_agent[47],
                                                                  self.agent_q_input[48]: pre_q_agent[48],
                                                                  self.agent_q_input[49]: pre_q_agent[49],
                                                                  self.agent_q_input[50]: pre_q_agent[50],
                                                                  self.agent_q_input[51]: pre_q_agent[51],
                                                                  self.agent_q_input[52]: pre_q_agent[52],
                                                                  self.agent_q_input[53]: pre_q_agent[53],
                                                                  self.agent_q_input[54]: pre_q_agent[54],
                                                                 #self.agent_q_input[17]: pre_q_agent[17],
                                                                  self.target_q: targets,
            ...
            if self.preset_lambda:
                ...
                qvalue = self.frl_q.eval(
                    {self.agent_q_input[0]: q_all[0],
                     ...
                     self.agent_q_input[5]: q_all[5],
                     self.agent_q_input[6]: q_all[6],
                     self.agent_q_input[7]: q_all[7],
                     self.agent_q_input[8]: q_all[8],
                     self.agent_q_input[9]: q_all[9],
                     self.agent_q_input[10]: q_all[10],
                     self.agent_q_input[11]: q_all[11],
                     self.agent_q_input[12]: q_all[12],
                     self.agent_q_input[13]: q_all[13],
                     self.agent_q_input[14]: q_all[14],
                     self.agent_q_input[15]: q_all[15],
                     self.agent_q_input[16]: q_all[16],
                     self.agent_q_input[17]: q_all[17],
                     self.agent_q_input[18]: q_all[18],
                     self.agent_q_input[19]: q_all[19],
                     self.agent_q_input[20]: q_all[20],
                     self.agent_q_input[21]: q_all[21],
                     self.agent_q_input[22]: q_all[22],
                     self.agent_q_input[23]: q_all[23],
                     self.agent_q_input[24]: q_all[24],
                     self.agent_q_input[25]: q_all[25],
                     self.agent_q_input[26]: q_all[26],
                     self.agent_q_input[27]: q_all[27],
                     self.agent_q_input[28]: q_all[28],
                     self.agent_q_input[29]: q_all[29],
                     self.agent_q_input[30]: q_all[30],
                     self.agent_q_input[31]: q_all[31],
                     self.agent_q_input[32]: q_all[32],
                     self.agent_q_input[33]: q_all[33],
                     self.agent_q_input[34]: q_all[34],
                     self.agent_q_input[35]: q_all[35],
                     self.agent_q_input[36]: q_all[36],
                     self.agent_q_input[37]: q_all[37],
                     self.agent_q_input[38]: q_all[38],
                     self.agent_q_input[39]: q_all[39],
                     self.agent_q_input[40]: q_all[40],
                     self.agent_q_input[41]: q_all[41],
                     self.agent_q_input[42]: q_all[42],
                     self.agent_q_input[43]: q_all[43],
                     self.agent_q_input[44]: q_all[44],
                     self.agent_q_input[45]: q_all[45],
                     self.agent_q_input[46]: q_all[46],
                     self.agent_q_input[47]: q_all[47],
                     self.agent_q_input[48]: q_all[48],
                     self.agent_q_input[49]: q_all[49],
                     self.agent_q_input[50]: q_all[50],
                     self.agent_q_input[51]: q_all[51],
                     self.agent_q_input[52]: q_all[52],
                     self.agent_q_input[53]: q_all[53],
                     self.agent_q_input[54]: q_all[54]
                     #self.agent_q_input[17]: q_all[17],
                     }) #(3,?,5)
